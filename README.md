...
**ด่านแคมเปญ 10 ด่าน** บน 3 แผนที่ ศัตรูดึงจากถิ่นอาศัยของด่านนั้น ผ่านแล้วได้เงิน ลูกบอล และหินเมก้า
...
| กลยุทธ์ | ผล |
|---|---|
| `best` (จัดทีมให้ธาตุครอบคลุม วางให้ถูกที่ เลี้ยงเลเวล) | ผ่านครบ 10 ด่าน แต่เสียหัวใจที่ด่าน 1, 3, 4 |
| `random` (จัดทีมมั่ว ไม่คิดเรื่องธาตุ) | **ตายที่ด่าน 4** |
| `idle` (วางแล้วปล่อยทิ้งไว้เฉย ๆ) | **ตายตั้งแต่ด่าน 1** |
