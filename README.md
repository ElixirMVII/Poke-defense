...
**ด่านแคมเปญ 10 ด่าน** บน 3 รูปทางเดิน × 10 ธีมสี ศัตรูดึงจากถิ่นอาศัยของด่านนั้น
...
ปลดล็อกตามจำนวนด่านที่ผ่านและสายพันธุ์ที่จับได้ (Mew ต้องผ่าน 10 ด่านและจับให้ได้ 80 สายพันธุ์)
...
js/campaign.js     นิยามด่าน 10 ด่าน เควสในตำนาน 5 เควส และตารางเป้าหมายความยากรายด่าน
...
```
dist/index.html          264 KB  — CSS + JS 14 ไฟล์รวมอยู่ในนี้หมด
...
| กลยุทธ์ | ผล |
|---|---|
| `best` (จัดทีมให้ธาตุครอบคลุม วางให้ถูกที่ เลี้ยงเลเวล) | ผ่านครบ 10 ด่าน เสียหัวใจ 7 ด่าน |
| `random` (จัดทีมมั่ว ไม่คิดเรื่องธาตุ) | **ตายที่ด่าน 4** |
| `idle` (วางเท่าที่เงินตั้งต้นพอ แล้วไม่แตะอะไรอีก) | **ตายตั้งแต่ด่าน 1 เวฟ 4** |
| เควสในตำนาน | ผ่านแบบเฉียดฉิว (กดเลือดได้ 16–23% จากเกณฑ์ 20–25%) |
